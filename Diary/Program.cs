    ...
    internal class Program
    {
        ...
        static void Page()
        {
            ...
            Page firstPage = new Page()
            {
                ...
                notes = new string[] { "Завтрак", "Написать философию" }
            };
            Page secondPage = new Page()
            {
                date = new DateTime(2022, 10, 20),
                notes = new string[] { "Сделать практическую по Python", "Посмотреть фильм", "Лечь спать до 23:00" }
            };
            Page thirdPage = new Page()
            {
                date = new DateTime(2022, 10, 21),
                notes = new string[] { "Поиграть в комп", "Сделать дз по вышмату" }
            };
                        ...
                        switch (page)
                        {
                            case 0:
                                ...
                                else if (arrowPosition == 3)
                                {
                                    ...
                                    Console.WriteLine($"Выбарана дата: {firstPage.date}");
                                    Console.WriteLine("<------------описание дела------------->");
                                    Console.WriteLine("Написать практическую по философии.");
                                }
                                break;
                            case 1:
                                if (arrowPosition == 2)
                                ...
                                else if (arrowPosition == 4)
                                {
                                    ...
                                    Console.WriteLine($"Выбарана дата: {secondPage.date}");
                                    Console.WriteLine("<------------описание дела------------->");
                                    Console.WriteLine("Завтра рано вставать, поэтому необходимо лечь до 23:00");
                                }
                                break;
                            case 2:
                                if (arrowPosition == 2)
                                {
                                    ...
                                    Console.WriteLine("<------------описание дела------------->");
                                    Console.WriteLine("Поиграть в какую-нибудь игру");
                                }
                                else if (arrowPosition == 3)
                                {
                                    Console.Clear();
